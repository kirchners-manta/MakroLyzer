...
from pytim [2]_ on an MDAnalysis universe [3]_. A random subset of eligible backbone carbons
is chosen.
...
.. [2]  Sega, M.; Kantorovich, S.; Jedlovszky, P.; Jorge, M. A generalized identification of truly interfacial molecules (GITIM). J. Chem. Phys. 2013, 138, 044110.
